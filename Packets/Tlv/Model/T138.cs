...
internal class T138Body : TlvBody
{
        ...
        : base(data)
    {
        ...
        for (int i = 0; i < count; ++i)
        {
            ...
            {
                case 0x0106:
                    TakeUintBE(out _chgTimeUnknown262);
                    break;
                case 0x010a:
                    TakeUintBE(out _chgTimeA2);
                    break;
                case 0x011c:
                    TakeUintBE(out _chgTimeLsKey);
                    break;
                case 0x0102:
                    TakeUintBE(out _chgTimeA8);
                    break;
                case 0x0103:
                    TakeUintBE(out _chgTimeStWeb);
                    break;
                case 0x0120:
                    TakeUintBE(out _chgTimeSKey);
                    break;
                case 0x0136:
                    TakeUintBE(out _chgTimeVKey);
                    break;
                case 0x0143:
                    TakeUintBE(out _chgTimeD2);
                    break;
                case 0x0164:
                    TakeUintBE(out _chgTimeSid);
                    break;
            }
